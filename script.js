...
// }
// let sum=0;
// arr.forEach(elements =>sum+=elements)
// if (arr>max,min) {
//     sum=sum-max-min
// }
//  console.log(sum);
...
// for (let i = 0; i < arr.length; i++) {
//     if (arr[i].unitPrice >20 && arr[i].unitPrice < 120 ) {
//         console.log(arr[i]);
//     }
// }
...
// const filtered=arr.filter((arr)=>arr.categoryId===4)
// console.log(filtered);




// const tapilan=arr.find(x=>x.name ==="Singaporean Hokkien Fried Mee")
// console.log(tapilan);